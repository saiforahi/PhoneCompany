...
int main()
{
	...
	Call call1("01671919344", "Robi",number1.get_number(),number1.get_operatorName(), "19728014444",P1, Subordinate, 4250);
	Call call2("01XXXXXXXXX","GP",number2.get_number(), number2.get_operatorName(), "19728014444", P2, Friend, 5250);
	Call call3("01XXXXXXXXX", "GP", number2.get_number(), number2.get_operatorName(), "19728014444", P3, Sibling, 12250);
	Call call4("01XXXXXXXXX", "GP", number2.get_number(), number2.get_operatorName(), "19728014444", P3, Spouse, 12250);
	Call call5("01XXXXXXXXX", "GP", number2.get_number(), number2.get_operatorName(), "19728014444", P3, Child, 12250);
	Call call6("01XXXXXXXXX", "GP", number2.get_number(), number2.get_operatorName(), "19728014444", P3, Boss, 12250);
	Call call7("01XXXXXXXXX", "GP", number2.get_number(), number2.get_operatorName(), "19728014444", P3, Relatives, 12250);
	Call call8("01XXXXXXXXX", "GP", number2.get_number(), number2.get_operatorName(), "19728014444", P3, Parent, 12250);
	Call call9("01XXXXXXXXX", "GP", number2.get_number(), number2.get_operatorName(), "19728014444", P3, Parent, 12250);
	Call call10("01XXXXXXXXX", "GP", number2.get_number(), number2.get_operatorName(), "19728014444", P3, Parent, 12250);
	Call call11("01XXXXXXXXX", "GP", number2.get_number(), number2.get_operatorName(), "19728014444", P3, Parent, 12250);
	Call call12("01XXXXXXXXX", "GP", number2.get_number(), number2.get_operatorName(), "19728014444", P3, Parent, 12250);
	Call call13("01XXXXXXXXX", "GP", number2.get_number(), number2.get_operatorName(), "19728014444", P3, Parent, 12250);
	Call call14("01XXXXXXXXX", "GP", number2.get_number(), number2.get_operatorName(), "19728014444", P3, Parent, 12250);
	Call call15("01XXXXXXXXX", "GP", number2.get_number(), number2.get_operatorName(), "19728014444", P3, Parent, 12250);
	Call call16("01XXXXXXXXX", "GP", number2.get_number(), number2.get_operatorName(), "19728014444", P3, Parent, 12250);
	Call call17("01XXXXXXXXX", "GP", number2.get_number(), number2.get_operatorName(), "19728014444", P3, Parent, 12250);
	Call call18("01XXXXXXXXX", "GP", number2.get_number(), number2.get_operatorName(), "19728014444", P3, Parent, 12250);
	Call call19("01XXXXXXXXX", "GP", number2.get_number(), number2.get_operatorName(), "19728014444", P3, Parent, 12250);
